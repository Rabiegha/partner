...
import {EventProvider, useEvent} from '../components/context/EventContext';
import {MMKV} from 'react-native-mmkv';
import ProfilScreen from '../screens/Profil';
// Continuez à importer le reste de vos écrans...
          ...
          options={{
            tabBarIcon: ({focused}) => (
              <View style={styles.navBarIcons}>
                <Image
                  source={require('../assets/images/icons/Participant.png')}
                  resizeMode="contain"
                  style={{
                    width: 32,
                    height: 32,
        ...
        <Tab.Screen
          ...
          options={{
            tabBarIcon: ({focused}) => (
              <View style={styles.navBarIcons}>
                <Image
                  source={require('../assets/images/icons/Ajouts.png')}
                  resizeMode="contain"
                  style={{
                    width: 32,
                    height: 32,
        ...
        <Tab.Screen
          ...
          options={{
            tabBarIcon: ({focused}) => (
              <View style={styles.navBarIcons}>
                <Image
                  source={require('../assets/images/icons/Profil.png')}
                  resizeMode="contain"
                  style={{
                    width: 30,
                    height: 30,
        ...
        <Tab.Screen
          ...
          options={{
            tabBarIcon: ({focused}) => (
              <View style={styles.navBarIcons}>
                <Image
                  source={require('../assets/images/icons/Outils.png')}
                  resizeMode="contain"
                  style={{
                    width: 32,
                    height: 32,
